...
YouTube Link: 
 - 從 Cilium 認識 cgroup ebpf: https://youtu.be/YR-aHMBNwPw
 - AWS SQS queues & Kubernetes Autoscaling Pitfalls Stories: https://youtu.be/L3ceXbH7ssI

| Topic       | Speaker        | Links |
|-------------|----------------|--------------|
| 從 Cilium 認識 cgroup ebpf | Ruian | [Slides](https://speakerdeck.com/rueian/cilium-and-cgroup-ebpf) |
| AWS SQS queues & Kubernetes Autoscaling Pitfalls Stories | Eric Khun | [Slides](https://speakerdeck.com/erickhun/aws-sqs-queues-and-kubernetes-autoscaling-pitfalls-stories) |
